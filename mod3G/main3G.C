...
/*    sr.SetInput(br1.GetOutput());
    ...
    lr4.SetInput2(gs.GetOutput());
    lr5.SetInput(gs.GetOutput());
...
*/
    br1.GetOutput()->Update();

    PNMwriter writer;
    writer.SetInput(br1.GetOutput()); //tb3.GetOutput());
    writer.Write(argv[2]);
/*
    CheckSum cs;
    cs.SetInput(br1.GetOutput());  //tb3.GetOutput());
